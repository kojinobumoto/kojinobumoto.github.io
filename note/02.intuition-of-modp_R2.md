...
katex: True
---
# intuition of [modp_R2](https://github.com/open-quantum-safe/liboqs/blob/main/src/sig/falcon/pqclean_falcon-1024_clean/keygen.c#L727-L756)
...
\\
(\text{where } r \text{ and } p \text{ are integers such that } r > p \text{ and } r \text{ is coprime to } p),
\end{aligned}
$$
