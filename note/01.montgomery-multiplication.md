...
how on the earth the actual implementation becomes as follows in [open-quantum-safe](https://github.com/open-quantum-safe) (for example, *modp_montymul()* in [src/sig/falcon/pqclean_falcon-1024_avx2/keygen.c](https://github.com/open-quantum-safe/liboqs/blob/main/src/sig/falcon/pqclean_falcon-1024_avx2/keygen.c#L711-L725) )?
```
/*
